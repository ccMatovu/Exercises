...
public class WeekdayCalculator {
    ...
    public static void main( String[] args )
    {
        ...
        System.out.println("12 10 2003 => " + weekday(12,17,1988));
    ...
    {
        int yy=yyyy-1900, total,remainder;
        String date = "";
    ...
    private static int month_offset(int month) {
        int result =1111;
    ...
    private static Object month_name(int mm) {
        switch(mm){
            case 1:
                return "January";
            case 2:
